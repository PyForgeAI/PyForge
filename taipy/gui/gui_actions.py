...
def notify(
    ...
    PyForge applications, you may be prompted to authorize the browser to do so. Please
...
def get_state_id(state: State) -> t.Optional[str]:
    ...
    The state identifier is a string generated by PyForge GUI for a given `State^` that is used
...
def get_context_id(state: State) -> t.Any:
    """NOT DOCUMENTED"""
    _warn("'get_context_id()' was deprecated in PyForge GUI 2.0. Use 'get_state_id()' instead.")
...
def invoke_state_callback(gui: Gui, state_id: str, callback: t.Callable, args: t.Union[t.Tuple, t.List]) -> t.Any:
    """NOT DOCUMENTED"""
    _warn("'invoke_state_callback()' was deprecated in PyForge GUI 2.0. Use 'Gui.invoke_callback()' instead.")
...
def invoke_long_callback(
    ...
    *user_function* is finished (successfully or not), or periodically (using the *period* parameter).
    ...
    Arguments:
        state (State^): The `State^` instance, as received in any callback.
        user_function (Callable[[...], None]): The function that will be run independently of PyForge GUI. Note
