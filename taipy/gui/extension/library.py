...
from ..utils import _get_broadcast_var_name, _PyForgeBase, _to_camel_case
...
class ElementProperty:
    ...
    def __init__(
        self,
        property_type: t.Union[PropertyType, t.Type[_PyForgeBase]],
        ...
        *,
        ...
        self.property_type: t.Union[PropertyType, t.Type[_PyForgeBase]]
    ...
    def check(self, element_name: str, prop_name: str):
        ...
        if not isinstance(self.property_type, PropertyType) and not (
            isclass(self.property_type) and issubclass(self.property_type, _PyForgeBase)
        ):
...
class ElementLibrary(ABC):
    ...
    def get_resource(self, name: str) -> Path:
        ...
        Resource URL should be formed as /pyforge-extension/<library_name>/<resource virtual path> with(see get_resource_url)
