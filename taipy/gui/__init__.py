...
"""# PyForge Graphical User Interface generator

The PyForge GUI package provides User Interface generation based on page templates. It can
...
Each page can contain regular text and images, as well as PyForge controls that are
typically linked to some value that is managed by the whole PyForge application.

Here is how you can create your first PyForge User Interface:

   - Create a Python source file.
     Copy these two lines into a file called *pyforge_app.py*.
     ```py title="pyforge_app.py"
     from pyforge import Gui

     if __name__ == "__main__":
         Gui("# Hello PyForge!").run()
     ```
   - Install PyForge:
     ```
     pip install pyforge
...
!!! Note "Optional packages"
    ...
    add functionality to PyForge GUI:
    ...
    - [`python-magic`](https://pypi.org/project/python-magic/): identifies image format
      ...
      or install PyForge GUI using: `pip install pyforge-gui[image]`.
    - [`pyarrow`](https://pypi.org/project/pyarrow/): can improve the performance of your
      ...
      or install PyForge GUI using: `pip install pyforge-gui[arrow]`.
    - [`simple-websocket`](https://pypi.org/project/simple-websocket/): enables the
      ...
      or install PyForge GUI using: `pip install pyforge-gui[simple-websocket]`.
    - [`pyngrok`](https://pypi.org/project/pyngrok/): enables use of [Ngrok](https://ngrok.com/)
      to access PyForge GUI application from the internet.<br/>
      You can install that package with the regular `pip install pyngrok` command,
      or install PyForge GUI using: `pip install pyforge-gui[pyngrok]`.
