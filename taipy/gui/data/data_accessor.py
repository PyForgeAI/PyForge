...
from ..utils import _PyForgeData
...
class _DataAccessors(object):
    ...
    def _get_instance(self, value: _PyForgeData) -> _DataAccessor:  # type: ignore
        value = value.get() if isinstance(value, _PyForgeData) else value
    ...
    def get_data(self, var_name: str, value: _PyForgeData, payload: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
        return self._get_instance(value).get_data(var_name, value.get(), payload, self.__data_format)

    def get_cols_description(self, var_name: str, value: _PyForgeData) -> t.Dict[str, t.Dict[str, str]]:
