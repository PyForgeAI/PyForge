...
class _DataScopes:
    ...
    def get_scope(self, client_id: t.Optional[str]) -> t.Tuple[SimpleNamespace, t.Dict[str, str]]:
        ...
        if client_id not in self.__scopes:
            _warn(
                f"Session id {client_id} not found in data scope. PyForge will automatically create a scope for this session id but you may have to reload your page."  # noqa: E501
            )
