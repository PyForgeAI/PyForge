...
class Page(BasePage):
    """NOT DOCUMENTED
    A custom page for external application that can be added to PyForge GUI"""
...
class ResourceHandler(ABC):
    ...
    data_layer_supported_types: t.Tuple[t.Type, ...] = (_PyForgeData, pd.DataFrame, pd.Series)
    ...
    @abstractmethod
    def get_resources(self, path: str, pyforge_resource_path: str, base_url: str) -> t.Any:
