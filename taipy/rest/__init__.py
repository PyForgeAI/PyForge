...
The PyForge Rest package exposes the Runnable `Rest^` service to expose REST APIs on top of PyForge Core
...
Once the `Rest^` service runs, users can call REST APIs to create, read, update, submit and remove PyForge entities
(including cycles, scenarios, sequences, tasks, jobs, and data nodes). It is handy when it comes to integrating a
PyForge application in a more complex IT ecosystem.
