...
from pyforge.core import DataNode
from pyforge.core.data._data_manager_factory import _DataManagerFactory
from pyforge.core.data.operator import Operator
from pyforge.core.exceptions.exceptions import NonExistingDataNode, NonExistingDataNodeConfig
...
class DataNodeResource(Resource):
    ...
    get:
      ...
      description: |
        ...
        !!! Note
          When the authorization feature is activated (available in PyForge Enterprise edition only), this endpoint
