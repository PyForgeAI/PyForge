...
class _PyForgeParser:
    """Argument parser for PyForge application."""
    ...
    _sub_pyforgeparsers: Dict[str, argparse.ArgumentParser] = {}
    ...
    def _add_subparser(cls, name: str, **kwargs) -> argparse.ArgumentParser:
        ...
        if subparser := cls._sub_pyforgeparsers.get(name):
            return subparser
        ...
        cls._sub_pyforgeparsers[name] = subparser
