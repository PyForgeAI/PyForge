...
from pyforge.core.config import CoreSection, DataNodeConfig, JobConfig, ScenarioConfig, TaskConfig
...
class Config:
    """Singleton class that manages the configuration of a PyForge application.

    The `Config` singleton is the main class to use for configuring a PyForge application.
    ...
    def configure_task(
        ...
        **properties,
        ...
        Arguments:
            ...
            function (Callable): The python function called by PyForge to run the task.
