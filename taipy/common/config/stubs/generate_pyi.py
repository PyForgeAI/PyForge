...
if __name__ == "__main__":
    header_file = "pyforge/common/config/stubs/pyi_header.py"
    config_init = Path("pyforge/core/config/__init__.py")
    base_config = "pyforge/common/config/config.py"

    dn_filename = "pyforge/core/config/data_node_config.py"
    job_filename = "pyforge/core/config/job_config.py"
    scenario_filename = "pyforge/core/config/scenario_config.py"
    task_filename = "pyforge/core/config/task_config.py"
    core_filename = "pyforge/core/config/core_section.py"
    ...
    with open("pyforge/common/config/config.pyi", "w") as f:
        f.writelines(pyi)
