...
from pyforge.common.config.exceptions.exceptions import InconsistentEnvVariableError

from ...data._data_manager_factory import _DataManagerFactory
from ...job._job_manager_factory import _JobManagerFactory
from ...scenario._scenario_manager_factory import _ScenarioManagerFactory
from ...sequence._sequence_manager_factory import _SequenceManagerFactory
from ...pyforge import clean_all_entities
...
class _VersionCLI(_AbstractCLI):
    ...
    def create_parser(cls):
        version_parser = _PyForgeParser._add_subparser(cls._COMMAND_NAME, help="PyForge version control system.")

        version_parser.add_argument(
            "-l", "--list", action="store_true", help="List all existing versions of the PyForge application."
        )

        version_parser.add_argument(
            "--rename", nargs=2, metavar=("OLD_VERSION", "NEW_VERSION"), help="Rename a PyForge version."
        )
        ...
        version_parser.add_argument(
            ...
            help="Compare the Configuration of 2 PyForge versions.",
        )

        version_parser.add_argument(
            "-d", "--delete", metavar="VERSION", help="Delete a PyForge version by version number."
        )
