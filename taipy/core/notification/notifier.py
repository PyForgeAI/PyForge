...
class Notifier:
    """A class for managing event registrations and publishing a PyForge application events."""
    ...
    def publish(cls, event: Event) -> None:
        """Publish a PyForge application event to all registered listeners whose topic matches the event.
