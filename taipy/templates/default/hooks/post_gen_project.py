...
def handle_services(use_rest, use_orchestrator):
    ...
    if use_orchestrator and use_rest:
        with open(os.path.join(os.getcwd(), "sections", "import.txt"), "a") as import_file:
            import_file.write("from pyforge import Orchestrator, Rest\n")
    elif use_orchestrator:
        with open(os.path.join(os.getcwd(), "sections", "import.txt"), "a") as import_file:
            import_file.write("from pyforge import Orchestrator\n")
    elif use_rest:
        with open(os.path.join(os.getcwd(), "sections", "import.txt"), "a") as import_file:
            import_file.write("from pyforge import Rest\n")
...
def handle_single_page_app():
    ...
    with open(os.path.join(os.getcwd(), "sections", "import.txt"), "a") as import_file:
        import_file.write("import pyforge.gui.builder as tgb\n")
...
print(
    f"New PyForge application has been created at {os.path.join(os.getcwd())}"
    f"{git_init_message}"
