...
from pyforge.core import get as core_get
from pyforge.core.data import JSONDataNode
from pyforge.core.data._file_datanode_mixin import _FileDataNodeMixin
from pyforge.core.data._tabular_datanode_mixin import _TabularDataNodeMixin
from pyforge.core.reason import ReasonCollection
from pyforge.gui._warnings import _warn
from pyforge.gui.gui import _DoNotUpdate
from pyforge.gui.utils import _is_boolean, _is_true, _PyForgeBase
...
class _GuiCoreScenarioAdapter(_PyForgeBase):
    __INNER_PROPS = ["name"]
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "Sc"


class _GuiCoreScenarioDagAdapter(_PyForgeBase):
    @staticmethod
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "ScG"


class _GuiCoreScenarioNoUpdate(_PyForgeBase, _DoNotUpdate):
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "ScN"


class _GuiCoreDatanodeAdapter(_PyForgeBase):
    @staticmethod
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "Dn"
...
class _GuiCoreScenarioFilter(_GuiCoreScenarioProperties, _PyForgeBase):
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "ScF"
...
class _GuiCoreScenarioSort(_GuiCoreScenarioProperties, _PyForgeBase):
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "ScS"
...
class _GuiCoreDatanodeFilter(_GuiCoreDatanodeProperties, _PyForgeBase):
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "DnF"
...
class _GuiCoreDatanodeSort(_GuiCoreDatanodeProperties, _PyForgeBase):
    ...
    @staticmethod
    def get_hash():
        return _PyForgeBase._HOLDER_PREFIX + "DnS"
