...
if __name__ == "__main__":
    paths = (
        ...
        if sys.argv[1] != "ALL"
            ...
            f"pyforge{os.sep}common",
            f"pyforge{os.sep}core",
            f"pyforge{os.sep}rest",
            f"pyforge{os.sep}gui",
            f"pyforge{os.sep}templates",
            "pyforge",
        ]
    )
    ...
    for _path in paths:
        ...
        _name = None if _path == "pyforge" else _path.split(os.sep)[-1]
