...
version_path = "pyforge/templates/version.json"

setup_requirements = Path("pyforge/templates/setup.requirements.txt")
...
setup(
    packages=find_packages(where=root_folder, include=["pyforge"]),
