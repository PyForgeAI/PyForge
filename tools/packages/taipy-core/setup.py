...
"""The setup script for pyforge-core package"""
...
version_path = "pyforge/core/version.json"

setup_requirements = Path("pyforge/core/setup.requirements.txt")
...
setup(
    ...
    packages=find_packages(where=root_folder, include=["pyforge", "pyforge.core", "pyforge.core.*"]),
