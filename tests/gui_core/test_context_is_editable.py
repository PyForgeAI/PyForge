...
from pyforge.core import Job, JobId, Scenario, Task
...
class TestGuiCoreContext_is_editable:
    ...
    def test_crud_scenario(self):
        with patch("pyforge.gui_core._context.core_get", side_effect=mock_core_get):
            ...
            with patch("pyforge.gui_core._context.is_editable", side_effect=mock_is_editable_false):
                assign.reset_mock()
                gui_core_context.crud_scenario(
                    MockState(assign=assign),
                    "",
    ...
    def test_act_on_jobs(self):
        with (
            ...
            with patch("pyforge.gui_core._context.is_readable", side_effect=mock_is_editable_false):
                gui_core_context.act_on_jobs(
                    MockState(assign=assign),
                    "",
                    {
