...
class TestGuiCoreContext_is_promotable:
    ...
    def test_edit_entity(self):
        with (
            ...
            patch("pyforge.gui_core._context.is_promotable", side_effect=mock_is_true),
        ):
            ...
            with patch("pyforge.gui_core._context.is_promotable", side_effect=mock_is_promotable_false):
                gui_core_context.edit_entity(
                    MockState(assign=assign),
                    "",
                    {
