...
class TestGuiCoreContext_is_submittable:
    def test_submit_entity(self):
        with (
            ...
            patch("pyforge.gui_core._context.is_submittable", side_effect=mock_has_no_reason),
        ):
            ...
            with patch("pyforge.gui_core._context.is_submittable", side_effect=mock_is_submittable_reason):
                assign.reset_mock()
                gui_core_context.submit_entity(
                    MockState(assign=assign),
                    "",
