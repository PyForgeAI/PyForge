...
class TestGuiCoreContext_is_deletable:
    def test_crud_scenario(self):
        with (
            ...
            with patch("pyforge.gui_core._context.is_deletable", side_effect=mock_is_deletable_false):
                assign.reset_mock()
                gui_core_context.crud_scenario(
                    MockState(assign=assign),
                    "",
    ...
    def test_act_on_jobs(self):
        with (
            ...
            with patch("pyforge.gui_core._context.is_readable", side_effect=mock_is_deletable_false):
                gui_core_context.act_on_jobs(
                    MockState(assign=assign),
                    "",
                    {
