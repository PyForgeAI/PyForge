...
from pyforge.core import DataNode, Scenario
from pyforge.core.data.pickle import PickleDataNode
from pyforge.gui.mock.mock_state import MockState
...
class TestGuiCoreContext_crud_scenario:
    def test_crud_scenario_delete(self):
        ...
        with (
            ...
            patch("pyforge.gui_core._context.core_delete", side_effect=mock_core_delete)
        ):
