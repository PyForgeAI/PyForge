...
from pyforge.gui.data.decimator.lttb import LTTB
from pyforge.gui.data.decimator.minmax import MinMaxDecimator
from pyforge.gui.data.decimator.rdp import RDP
from pyforge.gui.data.decimator.scatter_decimator import ScatterDecimator
