...
from pyforge.gui import Gui, Html, Markdown
from pyforge.gui._renderers.builder import _Builder
from pyforge.gui._warnings import PyForgeGuiWarning
from pyforge.gui.utils._variable_directory import _reset_name_map
from pyforge.gui.utils.expr_var_name import _reset_expr_var_name
...
class Helpers:
    ...
    def _test_control(gui: Gui, expected_values: t.Union[str, t.List]):
        ...
        response = client.get("/pyforge-jsx/test")
    ...
    @staticmethod
    def get_pyforge_warnings(warns: t.List[warnings.WarningMessage]) -> t.List[warnings.WarningMessage]:
        return [w for w in warns if issubclass(w.category, PyForgeGuiWarning)]
