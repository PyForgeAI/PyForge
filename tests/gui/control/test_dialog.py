...
def test_dialog_html_1(gui: Gui, helpers):
    ...
    dialog_open = False  # noqa: F841
    html_string = (
        '<pyforge:dialog title="This is a Dialog" open="{dialog_open}" page="page1" on_action="validate_action" />'
    )
    expected_list = [
        "<Dialog",
        'page="page1"',
...
def test_dialog_html_2(gui: Gui, helpers):
    ...
    dialog_open = False  # noqa: F841
    html_string = (
        '<pyforge:dialog title="Another Dialog" open="{dialog_open}" partial="{partial}" on_action="validate_action" />'
    )
    expected_list = [
        "<Dialog",
        'page="TaiPy_partials',
...
def test_dialog_labels_html(gui: Gui, helpers):
    ...
    dialog_open = False  # noqa: F841
    html_string = (
        '<pyforge:dialog title="Another Dialog" open="{dialog_open}" page="page_test" labels="Cancel;Validate" />'
    )
    expected_list = [
        "<Dialog",
        'page="page_test"',
