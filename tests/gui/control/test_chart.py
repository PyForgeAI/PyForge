...
def test_chart_html_1(gui: Gui, helpers, csvdata):
    ...
    html_string = '<pyforge:chart data="{csvdata}" x="Day" selected_color="green" y[1]="Daily hospital occupancy" label[1]="Entity" y[2]="Daily hospital occupancy" label[2]="Code" mode[2]="markers" color[2]="red" type[2]="scatter" xaxis[2]="x2" layout="{subplot_layout}" on_range_change="range_change" width="100%" height="100%" selected="{selected_indices}"  />'  # noqa: E501
    expected_list = [
        "<Chart",
        "selected0={tpec_TpExPr_selected_indices_TPMDL_0}",
        "selected1={tpec_TpExPr_selected_indices_TPMDL_0}",
...
def test_chart_html_2(gui: Gui, helpers, csvdata):
    ...
    html_string = '<pyforge:chart x="Day" selected_color="green" y[1]="Daily hospital occupancy" label[1]="Entity" y[2]="Daily hospital occupancy" label[2]="Code" mode[2]="markers" color[2]="red" type[2]="scatter" xaxis[2]="x2" layout="{subplot_layout}" on_range_change="range_change" width="100%" height="100%" selected="{selected_indices}" >{csvdata}</pyforge:chart>'  # noqa: E501
    expected_list = [
        "<Chart",
        "selected0={tpec_TpExPr_selected_indices_TPMDL_0}",
        "selected1={tpec_TpExPr_selected_indices_TPMDL_0}",
