...
from pyforge.common.config._config_comparator._comparator_result import _ComparatorResult
...
class TestConfigComparator:
    ...
    def test_comparator_compare_method_call(self):
        ...
        with mock.patch(
            "pyforge.common.config._config_comparator._config_comparator._ConfigComparator._find_conflict_config"
        ) as mck:
