...
def test_subparser(capfd):
    subcommand_1 = _PyForgeParser._add_subparser("subcommand_1", help="subcommand_1 help")
    subcommand_1.add_argument("--foo", "-f", help="foo help")
    subcommand_1.add_argument("--bar", "-b", help="bar help")

    subcommand_2 = _PyForgeParser._add_subparser("subcommand_2", help="subcommand_2 help")
...
def test_duplicate_subcommand():
    ...
    subcommand_2 = _PyForgeParser._add_subparser("subcommand_1", help="subcommand_2 help")
    ...
    assert len(_PyForgeParser._sub_pyforgeparsers) == 1


def test_groupparser(capfd):
    group_1 = _PyForgeParser._add_groupparser("group_1", "group_1 desc")
    group_1.add_argument("--foo", "-f", help="foo help")
    group_1.add_argument("--bar", "-b", help="bar help")

    group_2 = _PyForgeParser._add_groupparser("group_2", "group_2 desc")
...
def test_duplicate_group():
    ...
    group_2 = _PyForgeParser._add_groupparser("group_1", "group_2 desc")
    ...
    assert len(_PyForgeParser._arg_groups) == 1
