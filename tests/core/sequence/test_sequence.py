...
from pyforge.core.data.data_node import DataNode
from pyforge.core.data.in_memory import InMemoryDataNode
from pyforge.core.data.pickle import PickleDataNode
from pyforge.core.exceptions import AttributeKeyAlreadyExisted
...
def test_get_parents(sequence):
    with mock.patch("pyforge.core.get_parents") as mck:
        sequence.get_parents()
        mck.assert_called_once_with(sequence)


def test_subscribe_sequence():
    with mock.patch("pyforge.core.subscribe_sequence") as mck:
...
def test_unsubscribe_sequence():
    with mock.patch("pyforge.core.unsubscribe_sequence") as mck:
        sequence = Sequence({}, [], "id")
