...
from pyforge.core import Job
from pyforge.core import pyforge as tp
from pyforge.core._orchestrator._orchestrator import _Orchestrator
from pyforge.core._version._version_manager import _VersionManager
from pyforge.core.common import _utils
...
from pyforge.core.reason import WrongConfigType
...
from pyforge.core.sequence._sequence_manager import _SequenceManager
from pyforge.core.task._task_manager import _TaskManager
from pyforge.core.task.task import Task
from pyforge.core.task.task_id import TaskId
...
def test_notification_subscribe(mocker):
    mocker.patch("pyforge.core._entity._reload._Reloader._reload", side_effect=lambda m, o: o)
...
def test_submit():
    ...
    with patch("pyforge.core.task._task_manager._TaskManager._orchestrator", new=MockOrchestrator):
