...
from pyforge import Scope
from pyforge.common.config import Config
from pyforge.common.config.exceptions.exceptions import InvalidConfigurationId
from pyforge.core import create_scenario
from pyforge.core.common._utils import _Subscriber
...
from pyforge.core.cycle.cycle import Cycle, CycleId
from pyforge.core.data._data_manager_factory import _DataManagerFactory
from pyforge.core.data.in_memory import DataNode, InMemoryDataNode
from pyforge.core.data.pickle import PickleDataNode
from pyforge.core.exceptions.exceptions import (
...
def test_create_primary_scenario(cycle):
    ...
    with mock.patch("pyforge.core.get") as get_mck:
...
def test_is_deletable():
    with mock.patch("pyforge.core.scenario._scenario_manager._ScenarioManager._is_deletable") as mock_submit:
        scenario = Scenario("foo", set(), {})
...
def test_submit_scenario():
    with mock.patch("pyforge.core.scenario._scenario_manager._ScenarioManager._submit") as mock_submit:
        scenario = Scenario("foo", set(), {})
...
def test_subscribe_scenario():
    with mock.patch("pyforge.core.subscribe_scenario") as mock_subscribe:
        scenario = Scenario("foo", set(), {})
...
def test_unsubscribe_scenario():
    with mock.patch("pyforge.core.unsubscribe_scenario") as mock_unsubscribe:
        scenario = Scenario("foo", set(), {})
...
def test_add_tag_scenario():
    with mock.patch("pyforge.core.tag") as mock_add_tag:
        scenario = Scenario("foo", set(), {})
...
def test_remove_tag_scenario():
    with mock.patch("pyforge.core.untag") as mock_remove_tag:
        scenario = Scenario("foo", set(), {})
