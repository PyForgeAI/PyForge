...
from pyforge.core._orchestrator._dispatcher import _DevelopmentJobDispatcher, _StandaloneJobDispatcher
...
from pyforge.core.exceptions import ModeNotAvailable
from pyforge.core.exceptions.exceptions import OrchestratorNotBuilt
...
def test_build_orchestrator():
    ...
    with mock.patch("pyforge.core._orchestrator._orchestrator_factory._OrchestratorFactory._build_dispatcher") as bd:
        with mock.patch("pyforge.core._orchestrator._orchestrator._Orchestrator.initialize") as initialize:
...
def test_rebuild_standalone_dispatcher_and_force_restart():
    ...
    with mock.patch("pyforge.core._orchestrator._dispatcher._job_dispatcher._JobDispatcher.start") as start_mock:
        with mock.patch("pyforge.core._orchestrator._dispatcher._job_dispatcher._JobDispatcher.stop") as stop_mock:
            _OrchestratorFactory._build_dispatcher()
            assert isinstance(_OrchestratorFactory._dispatcher, _StandaloneJobDispatcher)
