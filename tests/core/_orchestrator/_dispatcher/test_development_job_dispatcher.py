...
from pyforge.core._orchestrator._dispatcher import _DevelopmentJobDispatcher
...
def test_dispatch_executes_the_function_no_exception():
    ...
    with patch("pyforge.core._orchestrator._dispatcher._task_function_wrapper._TaskFunctionWrapper.execute") as mck:
        mck.return_value = []
