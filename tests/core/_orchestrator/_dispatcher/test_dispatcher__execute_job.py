...
from pyforge.core._orchestrator._dispatcher import _JobDispatcher
...
def test_execute_job():
    ...
    with mock.patch("pyforge.core._orchestrator._dispatcher._job_dispatcher._JobDispatcher._dispatch") as mck_1:
        with mock.patch("pyforge.core._orchestrator._dispatcher._job_dispatcher._JobDispatcher._needs_to_run") as mck_2:
...
def test_execute_jobs_synchronously():
    ...
    with mock.patch("pyforge.core._orchestrator._dispatcher._job_dispatcher._JobDispatcher._execute_job") as mck:
