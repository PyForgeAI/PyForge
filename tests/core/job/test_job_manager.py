...
from pyforge.core._orchestrator._dispatcher import _StandaloneJobDispatcher
...
from pyforge.core.exceptions.exceptions import JobNotDeletedException
...
@mock.patch(
    "pyforge.core._orchestrator._orchestrator._Orchestrator._orchestrate_job_to_run_or_block",
    return_value="orchestrated_job",
)
@mock.patch("pyforge.core._orchestrator._orchestrator._Orchestrator._cancel_jobs")
...
@mock.patch("pyforge.core.job.job.Job.canceled")
