...
from pyforge.common.config._serializer._json_serializer import _JsonSerializer
...
pyforge_storage_folder = ".pyforge/"
...
test_json_dn = [ "tests.core.config.test_config_serialization.compare_function:function",]
    ...
    assert Config.unique_sections[CoreSection.name].root_folder == "./pyforge/"
