...
from pyforge.common.config.global_app.global_app_config import GlobalAppConfig
from pyforge.core.config import CoreSection
...
from pyforge.core.config.task_config import TaskConfig
...
def _test_default_core_section(core_section: CoreSection):
    ...
    assert core_section.root_folder == "./pyforge/"
    assert core_section.storage_folder == "user_data/"
    assert core_section.pyforge_storage_folder == ".pyforge/"
