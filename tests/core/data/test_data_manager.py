...
from pyforge.core.data.data_node_id import DataNodeId
from pyforge.core.data.in_memory import InMemoryDataNode
from pyforge.core.data.pickle import PickleDataNode
from pyforge.core.exceptions.exceptions import InvalidDataNodeType, ModelNotFound
from pyforge.core.reason import NotGlobalScope, WrongConfigType
...
class TestDataManager:
    ...
    def test_create_dn_from_loaded_config_no_scope(self):
        ...
        from pyforge import core as tp
