...
from pyforge.core.data.aws_s3 import S3ObjectDataNode
...
class TestS3ObjectDataNode:
    __properties = [
        {
            ...
            "aws_s3_bucket_name": "pyforge",
            "aws_s3_object_key": " pyforge-object",
    ...
    def test_write_text(self, properties, data):
        ...
        # Create PyForge S3ObjectDataNode
    ...
    def test_read_text(self, properties, data):
        ...
        # Create PyForge S3ObjectDataNode
        aws_s3_object_dn = S3ObjectDataNode("foo_aws_s3", Scope.SCENARIO, properties=properties)
        # Read the Object from bucket with PyForge
    ...
    def test_read_file_data(self, properties, data_path):
        ...
        # Create PyForge S3ObjectDataNode
        aws_s3_object_dn = S3ObjectDataNode("foo_aws_s3", Scope.SCENARIO, properties=properties)
        # Read the file from bucket with PyForge should return the binary data of the uploaded file
        read_data = aws_s3_object_dn._read()
