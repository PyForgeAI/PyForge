...
from pyforge.core.data.data_node_id import (
    EDIT_COMMENT_KEY,
    EDIT_EDITOR_ID_KEY,
    EDIT_JOB_ID_KEY,
    EDIT_TIMESTAMP_KEY,
...
from pyforge.core.exceptions.exceptions import DataNodeIsBeingEdited, NoData
...
class TestDataNode:
    ...
    def test_change_data_node_name(self):
        ...
        # This new syntax will be the only one allowed: https://github.com/Avaiga/pyforge-core/issues/806
