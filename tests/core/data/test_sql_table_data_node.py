...
from pyforge.core.exceptions.exceptions import InvalidExposedType, MissingRequiredProperty
...
class TestSQLTableDataNode:
    ...
    @patch("pyforge.core.data.sql_table.SQLTableDataNode._read_as_pandas_dataframe", return_value="pandas")
    @pytest.mark.parametrize("properties", __sql_properties)
    ...
    def test_engine_cache(self, _, properties):
        ...
        with (
            ...
            patch("pyforge.core.data.sql_table.SQLTableDataNode._create_table"),
        ):
