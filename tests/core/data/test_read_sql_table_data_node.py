...
from pyforge.core.data.sql_table import SQLTableDataNode
...
class TestReadSQLTableDataNode:
    ...
    def test_build_connection_string(self):
        ...
        assert (
            ...
            == "mssql+pyodbc://sa:Passw0rd@localhost:1433/pyforge?TrustServerCertificate=yes&other=value&driver=default+server"
        )
        ...
        assert (
            ...
            == "mysql+pymysql://sa:Passw0rd@localhost:1433/pyforge?TrustServerCertificate=yes&other=value&driver=default+server"
        )
        ...
        assert (
            ...
            == "postgresql+psycopg2://sa:Passw0rd@localhost:1433/pyforge?TrustServerCertificate=yes&other=value&driver=default+server"
        )
        ...
        assert sqlite_sql_data_node._conn_string() == "sqlite:///pyforge.db"
