...
from pyforge.rest.api.middlewares._middleware import _middleware
...
@patch("pyforge.rest.api.middlewares._middleware._using_enterprise")
@patch("pyforge.rest.api.middlewares._middleware._enterprise_middleware")
