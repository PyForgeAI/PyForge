...
def test_get_scenario(client, default_scenario):
    ...
    with mock.patch("pyforge.core.scenario._scenario_manager._ScenarioManager._get") as manager_mock:
...
def test_delete_scenario(client):
    ...
    with (
        mock.patch("pyforge.core.scenario._scenario_manager._ScenarioManager._delete"),
        mock.patch("pyforge.core.scenario._scenario_manager._ScenarioManager._get"),
    ):
        # test get_scenario
