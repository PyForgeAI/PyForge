...
def test_get_cycle(client, default_cycle):
    ...
    with mock.patch("pyforge.core.cycle._cycle_manager._CycleManager._get") as manager_mock:
...
def test_delete_cycle(client):
    ...
    with mock.patch("pyforge.core.cycle._cycle_manager._CycleManager._delete"), mock.patch(
        "pyforge.core.cycle._cycle_manager._CycleManager._get"
    ):
        # test get_cycle
