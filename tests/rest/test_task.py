...
def test_get_task(client, default_task):
    ...
    with mock.patch("pyforge.core.task._task_manager._TaskManager._get") as manager_mock:
...
def test_delete_task(client):
    ...
    with (
        mock.patch("pyforge.core.task._task_manager._TaskManager._delete"),
        mock.patch("pyforge.core.task._task_manager._TaskManager._get"),
    ):
        # test get_task
...
def test_create_task(client, default_task_config):
    ...
    with mock.patch("pyforge.rest.api.resources.task.TaskList.fetch_config") as config_mock:
