...
def test_get_datanode(client, default_datanode):
    ...
    with mock.patch("pyforge.core.data._data_manager._DataManager._get") as manager_mock:
...
def test_delete_datanode(client):
    ...
    with (
        mock.patch("pyforge.core.data._data_manager._DataManager._delete"),
        mock.patch("pyforge.core.data._data_manager._DataManager._get"),
    ):
        # test get_datanode
...
def test_create_datanode(client, default_datanode_config):
    ...
    with mock.patch("pyforge.rest.api.resources.datanode.DataNodeList.fetch_config") as config_mock:
...
def test_read_datanode(client, default_df_datanode):
    with mock.patch("pyforge.core.data._data_manager._DataManager._get") as config_mock:
