...
def test_get_job(client, default_job):
    ...
    with mock.patch("pyforge.core.job._job_manager._JobManager._get") as manager_mock:
...
def test_delete_job(client):
    ...
    with mock.patch("pyforge.core.job._job_manager._JobManager._delete"), mock.patch(
        "pyforge.core.job._job_manager._JobManager._get"
    ):
        # test get_job
...
def test_create_job(client, default_task_config):
    ...
    with mock.patch("pyforge.rest.api.resources.job.JobList.fetch_config") as config_mock:
