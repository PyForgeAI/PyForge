...
from pyforge.gui import Gui, Icon, State, get_state_id, invoke_callback, invoke_long_callback
...
user_agent = "https://pyforge.io/demo"
...
users = [
    ...
    ["pyforge", Icon("https://docs.pyforge.io/en/latest/assets/images/favicon.png", "PyForge")],
]
