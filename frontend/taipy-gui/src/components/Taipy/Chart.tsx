...
import { getArrayValue, getUpdateVar, PyForgeActiveProps, PyForgeChangeProps } from "./utils";

const Plot = lazy(() => import("react-plotly.js"));

interface ChartProp extends PyForgeActiveProps, PyForgeChangeProps {
    title?: string;
    width?: string | number;
...
export const PyForgePlotlyButtons: ModeBarButtonAny[] = [
    {
        name: "Full screen",
        title: "Full screen",
        icon: {
...
const isDataRefresh = (data?: Record<string, TraceValueType>) => data?.__pyforge_refresh !== undefined;
...
const Chart = (props: ChartProp) => {
    ...
    const plotConfig = useMemo(() => {
        ...
        plConf.modeBarButtonsToAdd = PyForgePlotlyButtons;
