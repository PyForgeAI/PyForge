...
import { createSendUpdateAction } from "../../context/pyforgeReducers";
import { getSuffixedClassNames, PyForgeActiveProps, PyForgeChangeProps, DateProps, getProps, getCssSize } from "./utils";
...
interface DateSelectorProps extends PyForgeActiveProps, PyForgeChangeProps {
    withTime?: boolean;
    format?: string;
    date: string;
    min?: string;
