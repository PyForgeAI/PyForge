...
import PyForgeNotification from "./Notification";
import { NotificationMessage } from "../../context/pyforgeReducers";
...
describe("Alert Component", () => {
    ...
    it("renders", async () => {
        const { getByText } = render(
            <SnackbarProvider>
                <PyForgeNotification notifications={defaultNotifications} />
            </SnackbarProvider>,
        );
    ...
    it("displays an error alert", async () => {
        const { getByText } = render(
            <SnackbarProvider>
                <PyForgeNotification notifications={getNotificationsWithType("error")} />
            </SnackbarProvider>,
        );
        const elt = getByText(defaultMessage);
    ...
    it("displays a warning alert", async () => {
        const { getByText } = render(
            <SnackbarProvider>
                <PyForgeNotification notifications={getNotificationsWithType("warning")} />
            </SnackbarProvider>,
        );
        const elt = getByText(defaultMessage);
    ...
    it("displays an info alert", async () => {
        const { getByText } = render(
            <SnackbarProvider>
                <PyForgeNotification notifications={getNotificationsWithType("info")} />
            </SnackbarProvider>,
        );
        const elt = getByText(defaultMessage);
    ...
    it("gets favicon URL from document link tags", () => {
        ...
        render(
            <SnackbarProvider>
                <PyForgeNotification notifications={alerts} />
            </SnackbarProvider>,
        );
    ...
    it("Alert disappears when alert type is empty", async () => {
        ...
        rerender(
            <SnackbarProvider>
                <PyForgeNotification notifications={newAlerts} />
            </SnackbarProvider>,
        );
        await waitFor(() => {
            const alertMessage = screen.queryByText("Test Alert");
    ...
    it("does nothing when alert is undefined", async () => {
        render(
            <SnackbarProvider>
                <PyForgeNotification notifications={[]} />
            </SnackbarProvider>,
        );
