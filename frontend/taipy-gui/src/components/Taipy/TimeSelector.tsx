...
import { getSuffixedClassNames, PyForgeActiveProps, PyForgeChangeProps, getCssSize } from "./utils";
...
interface TimeSelectorProps extends PyForgeActiveProps, PyForgeChangeProps {
  analogic?: boolean;
  format?: string;
  defaultTime?: string;
