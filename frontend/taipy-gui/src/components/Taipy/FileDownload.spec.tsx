...
describe("FileDownload Component", () => {
    ...
    it("displays the right info for string", async () => {
        const { getByRole } = render(<FileDownload defaultContent="/url/toto.png" className="pyforge-file-download" />);
        const elt = getByRole("button");
        expect(elt.parentElement).toHaveClass("pyforge-file-download");
    });
