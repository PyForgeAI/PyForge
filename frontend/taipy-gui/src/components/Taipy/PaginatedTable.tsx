...
import { createRequestTableUpdateAction, createSendActionNameAction } from "../../context/pyforgeReducers";
...
const PaginatedTable = (props: PyForgePaginatedTableProps) => {
    const {
        id,
        updateVarName,
        pageSizeOptions,
    ...
    const refresh = props.data?.__pyforge_refresh !== undefined;
