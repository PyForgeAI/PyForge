...
describe("Input Component", () => {
    ...
    it("displays the right info for string", async () => {
        const { getByDisplayValue } = render(
            <Input value="toto" type="text" defaultValue="titi" className="pyforge-input" />,
        );
        const elt = getByDisplayValue("toto");
        expect(elt.parentElement?.parentElement).toHaveClass("pyforge-input");
    });
...
describe("Number Component", () => {
    ...
    it("displays the right info for string", async () => {
        const { getByDisplayValue } = render(
            <Input value="12" type="number" defaultValue="1" className="pyforge-number" />,
        );
        const elt = getByDisplayValue(12);
        expect(elt.parentElement?.parentElement).toHaveClass("pyforge-number");
    });
    it("displays the default value", async () => {
        const { getByDisplayValue } = render(
