...
import { PyForgeActiveProps, PyForgeChangeProps, PyForgeLabelProps } from "./utils";
import { getInitials } from "../../utils";
import { LovItem } from "../../utils/lov";
import { stringIcon, Icon, IconAvatar, avatarSx } from "../../utils/icon";

export interface SelTreeProps extends LovProps, PyForgeLabelProps {
    filter?: boolean;
    multiple?: boolean;
    width?: string | number;
}

export interface LovProps<T = string | string[], U = string> extends PyForgeActiveProps, PyForgeChangeProps {
    defaultLov?: string;
    lov?: LoV;
    value?: T;
    defaultValue?: U;
