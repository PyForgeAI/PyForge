...
import { NotificationMessage, createDeleteAlertAction } from "../../context/pyforgeReducers";
...
const PyForgeNotification = ({ notifications }: NotificationProps) => {
    ...
    useEffect(() => {
        if (notification) {
            ...
            if (notification.atype === "") {
                ...
                notification.system &&
                    new Notification(document.title || "PyForge", { body: notification.message, icon: faviconUrl });
            }
...
export default PyForgeNotification;
