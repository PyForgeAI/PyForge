...
import { createSendActionNameAction, createSendUpdateAction } from "../../context/pyforgeReducers";
import { useClassNames, useDispatch, useDynamicProperty, useModule } from "../../utils/hooks";
import PyForgeRendered from "../pages/PyForgeRendered";
import { getSuffixedClassNames, PyForgeActiveProps, PyForgeChangeProps } from "./utils";
import { getComponentClassName } from "./PyForgeStyle";

type AnchorType = "left" | "bottom" | "right" | "top" | undefined;

interface PaneProps extends PyForgeActiveProps, PyForgeChangeProps {
    children?: ReactNode;
    open?: boolean;
