...
import { getCssSize, getSuffixedClassNames, PyForgeActiveProps, PyForgeChangeProps, DateProps, getProps } from "./utils";
...
interface DateRangeProps extends PyForgeActiveProps, PyForgeChangeProps {
    withTime?: boolean;
    format?: string;
    dates: string[];
    defaultDates?: string;
