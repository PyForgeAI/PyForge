...
interface PyForgeDynamicProps extends PyForgeBaseProps {
...
export interface PyForgeLabelProps {
    label?: string;
}
...
export interface PyForgeInputProps extends PyForgeActiveProps, PyForgeChangeProps, PyForgeLabelProps {
    type: string;
    value: string;
    defaultValue?: string;
    step?: number;
