...
describe("Part Component", () => {
    ...
    it("displays the right info for string", async () => {
        const {getByText} = render(<Part className="pyforge-part">bar</Part>);
        const elt = getByText("bar");
        expect(elt).toHaveClass("pyforge-part");
    })
    ...
    it("renders an iframe", async () => {
        const {getByText} = render(<Part className="pyforge-part" page="http://pyforge.io">bar</Part>);
        const elt = getByText("bar");
