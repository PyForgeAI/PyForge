...
import { PyForgeActiveProps, PyForgeChangeProps, getCssSize } from "./utils";
import { PyForgeContext } from "../../context/pyforgeContext";
import { createSendUpdateAction, createThemeAction } from "../../context/pyforgeReducers";
...
interface ThemeToggleProps extends PyForgeActiveProps, PyForgeChangeProps {
    style?: SxProps;
    label?: string;
    width?: string | number;
}
