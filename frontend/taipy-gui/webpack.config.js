...
const reactBundle = "pyforge-gui-deps"
const pyforgeBundle = "pyforge-gui"

const reactBundleName = "PyForgeGuiDependencies"
const pyforgeBundleName = "PyForgeGui"
const pyforgeGuiBaseBundleName = "PyForgeGuiBase"
...
const pyforgeDllPath = resolveApp(basePath + "/" + pyforgeBundle + ".js")
...
module.exports = (env, options) => {
    ...
    return [{
        ...
        {
            mode: options.mode, //'development', //'production',
            name: pyforgeBundleName,
            entry: ["./src/extensions/exports.ts"],
            output: {
                filename: pyforgeBundle + ".js",
                path: webAppPath,
                library: {
                    name: pyforgeBundleName,
                    type: "umd"
        ...
        },
        {
            ...
            entry: ["./src/index.tsx"],
            output: {
                filename: "pyforge-gui-dom.js",
                path: webAppPath,
                publicPath: "",
            },
            dependencies: [pyforgeBundleName, reactBundleName],
            externals: {"pyforge-gui": pyforgeBundleName},
            ...
            plugins: [
                ...
                new GenerateJsonPlugin("pyforge.status.json", envVariables),
                new ESLintPlugin({
                    extensions: [`ts`, `tsx`],
                    exclude: [`/node_modules/`],
                    eslintPath: require.resolve("eslint"),
    ...
    },
    {
        ...
        plugins: [
            new CopyWebpackPlugin({
                patterns: [
                    { from: "./base/src/packaging", to: pyforgeGuiBaseExportPath },
                ],
            }),
        ],
    }];
