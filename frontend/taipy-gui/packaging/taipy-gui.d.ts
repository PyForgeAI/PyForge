...
export interface PyForgeActiveProps extends PyForgeDynamicProps, PyForgeHoverProps {
    defaultActive?: boolean;
    active?: boolean;
}
export interface PyForgeHoverProps {
    hoverText?: string;
    defaultHoverText?: string;
}
export interface PyForgeDynamicProps extends PyForgeBaseProps {
    updateVarName?: string;
    propagate?: boolean;
    updateVars?: string;
}
export interface PyForgeBaseProps {
    id?: string;
    libClassName?: string;
    className?: string;
    dynamicClassName?: string;
}
export interface DialogProps extends PyForgeActiveProps {
    title: string;
    onAction?: string;
    closeLabel?: string;
    labels?: string;
...
export interface ChartProp extends PyForgeActiveProps, PyForgeChangeProps {
    title?: string;
    width?: string | number;
    height?: string | number;
...
export interface PyForgeMultiSelectProps {
    selected?: number[];
}
export interface PyForgeChangeProps {
    onChange?: string;
}

export type TableValueType = Record<string, Record<string, any>>;
export interface PyForgeTableProps extends PyForgeActiveProps, PyForgeMultiSelectProps {
    data?: TableValueType;
    columns?: string;
...
export interface PyForgePaginatedTableProps extends PyForgeTableProps {
    pageSizeOptions?: string;
    allowAllRows?: boolean;
    showAll?: boolean;
}
export interface TableProps extends PyForgePaginatedTableProps {
    autoLoading?: boolean;
}
...
export interface FileSelectorProps extends PyForgeActiveProps {
    onAction?: string;
    defaultLabel?: string;
    label?: string;
    multiple?: boolean;
 ...
 * @param dispatch - The React dispatcher associated to `PyForgeContext`.
